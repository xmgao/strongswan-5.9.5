...
ACLOCAL = ${SHELL} /home/wang/strongswan-5.9.5/missing aclocal-1.16
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
ATOMICLIB = 
AUTOCONF = ${SHELL} /home/wang/strongswan-5.9.5/missing autoconf
AUTOHEADER = ${SHELL} /home/wang/strongswan-5.9.5/missing autoheader
AUTOMAKE = ${SHELL} /home/wang/strongswan-5.9.5/missing automake-1.16
AWK = mawk
BFDLIB = 
BTLIB = 
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -Wall -Wno-format -Wno-format-security -Wno-pointer-sign -include /home/wang/strongswan-5.9.5/config.h
COVERAGE_CFLAGS = 
COVERAGE_LDFLAGS = 
CPP = gcc -E
CPPFLAGS = 
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/wang/strongswan-5.9.5/missing makeinfo
MANIFEST_TOOL = :
...
PACKAGE_STRING = strongSwan 5.9.5
PACKAGE_TARNAME = strongswan
PACKAGE_URL = 
PACKAGE_VERSION = 5.9.5
PACKAGE_VERSION_BUILD = 5
...
YACC = bison -y
YFLAGS = 
abs_builddir = /home/wang/strongswan-5.9.5
abs_srcdir = /home/wang/strongswan-5.9.5
abs_top_builddir = /home/wang/strongswan-5.9.5
abs_top_srcdir = /home/wang/strongswan-5.9.5
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
aikgen_plugins =  sha2 sha1 md5 random nonce x509 pubkey pkcs1 pem gmalg
am__include = include
am__leading_dot = .
am__quote = 
am__tar = tar --format=ustar -chf - "$$tardir"
am__untar = tar -xf -
attest_plugins =  sha2 sha1 md5 random x509 pkcs1 pkcs8 pem gmalg
...
build_vendor = pc
builddir = .
c_plugins =  attr kernel-libipsec kernel-netlink resolve socket-default stroke vici updown eap-identity eap-md5 eap-mschapv2 eap-dynamic eap-radius eap-tls eap-ttls eap-peap eap-tnc xauth-generic xauth-eap xauth-pam dhcp certexpire radattr addrblock unity counters
charon_natt_port = 4500
charon_plugins =  aes des rc2 sha2 sha1 md5 random nonce x509 revocation constraints pubkey pkcs1 pkcs7 pkcs8 pkcs12 pgp dnskey sshkey pem gmalg fips-prf curve25519 xcbc cmac hmac gcm drbg attr kernel-libipsec kernel-netlink resolve socket-default stroke vici updown eap-identity eap-md5 eap-mschapv2 eap-dynamic eap-radius eap-tls eap-ttls eap-peap eap-tnc xauth-generic xauth-eap xauth-pam tnc-tnccs dhcp certexpire radattr addrblock unity counters
charon_udp_port = 500
clearsilver_LIBS = 
cmd_plugins =  aes des rc2 sha2 sha1 md5 random nonce x509 revocation constraints pubkey pkcs1 pkcs7 pkcs8 pkcs12 sshkey pem gmalg fips-prf curve25519 xcbc cmac hmac gcm drbg kernel-libipsec kernel-netlink resolve socket-default eap-identity eap-md5 eap-mschapv2 eap-tls eap-ttls eap-peap xauth-generic
datadir = ${datarootdir}
...
exec_prefix = ${prefix}
fips_mode = 0
fuzz_plugins =  sha2 sha1 x509 pkcs1 pem
...
install_sh = ${SHELL} /home/wang/strongswan-5.9.5/install-sh
ipsec_script = ipsec
...
manager_plugins =  sha1 random pkcs1 pkcs8 pem gmalg
mandir = ${datarootdir}/man
medsrv_plugins =  sha2 sha1 random pkcs1 pkcs8 pem gmalg
mkdir_p = $(MKDIR_P)
nm_CFLAGS = 
nm_LIBS = 
nm_ca_dir = /usr/share/ca-certificates
nm_plugins =  aes des rc2 sha2 sha1 md5 random nonce x509 revocation constraints pkcs1 pkcs7 pkcs8 sshkey pem gmalg fips-prf curve25519 xcbc cmac hmac gcm drbg kernel-netlink socket-default eap-identity eap-md5 eap-mschapv2 eap-tls eap-ttls eap-peap
...
pki_plugins =  aes des rc2 sha2 sha1 md5 random x509 revocation pubkey pkcs1 pkcs7 pkcs8 pkcs12 dnskey sshkey pem gmalg curve25519 hmac drbg
...
s_plugins =  aes des rc2 sha2 sha1 md5 random nonce x509 revocation constraints pubkey pkcs1 pkcs7 pkcs8 pkcs12 pgp dnskey sshkey pem gmalg fips-prf curve25519 xcbc cmac hmac gcm drbg
sbindir = ${exec_prefix}/sbin
scepclient_plugins =  aes des rc2 sha2 sha1 md5 random x509 pkcs1 pkcs7 pkcs8 pkcs12 pem gmalg
scripts_plugins =  aes des rc2 sha2 sha1 md5 random x509 pkcs1 pkcs7 pkcs8 pkcs12 pem gmalg curve25519 hmac gcm drbg
...
strongswan_options =  charon charon-logging starter tnc scepclient pki swanctl
